...
export const Endpoints = {
	...
	GUILD_SCHEDULED_EVENTS: (guildId: string) => `/guilds/${guildId}/scheduled-events`,
	GUILD_SCHEDULED_EVENT: (guildId: string, eventId: string) => `/guilds/${guildId}/scheduled-events/${eventId}`,
	GUILD_SCHEDULED_EVENT_USERS: (guildId: string, eventId: string) => `/guilds/${guildId}/scheduled-events/${eventId}/users`,
	GUILD_SCHEDULED_EVENT_USER_ME: (guildId: string, eventId: string) => `/guilds/${guildId}/scheduled-events/${eventId}/users/@me`,
	...
	GUILD_SOUNDBOARD_PLAY: (guildId: string) => `/guilds/${guildId}/soundboard/play`,
	GUILD_SOUNDBOARD_AUDIO: (guildId: string, soundId: string) => `/guilds/${guildId}/soundboard/${soundId}/audio`,
