...
export type SoundID = Brand<bigint, 'SoundID'>;
...
export function createSoundID<T extends bigint>(id: T extends BrandedValue ? never : T): SoundID {
	return brand<T, 'SoundID'>(id);
}
