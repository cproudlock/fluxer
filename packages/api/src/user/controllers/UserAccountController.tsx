...
export function UserAccountController(app: HonoApp) {
	...
	// FCM tokens are device-bound and opaque (generated by Firebase on the physical device).
	// Cross-user token registration is mitigated by the token being unknowable without
	// physical device access. No additional device-ownership validation is needed.
	app.post(
		'/users/@me/fcm/tokens',
