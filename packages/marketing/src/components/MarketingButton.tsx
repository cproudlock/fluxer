...
export function MarketingButton({
	...
	const marketingClasses =
		`rounded-xl bg-[#3B82F6] font-semibold text-white shadow-lg transition hover:bg-[#2563EB] ${sizeClass} ${className}`.trim();
...
export function MarketingButtonSecondary({
	...
	const combinedClasses =
		`inline-flex items-center gap-2 rounded-xl border-2 border-[#3B82F6] font-semibold text-[#3B82F6] shadow-lg transition hover:bg-[#3B82F6]/10 ${sizeClass} ${className}`.trim();
...
export function MarketingButtonInverted({
	...
	const sizeClass = marketingButtonSizeClasses[size];
	const combinedClasses =
		`inline-flex items-center justify-center gap-2 rounded-2xl bg-white font-semibold text-[#3B82F6] shadow-lg transition hover:bg-gray-100 ${sizeClass} ${className}`.trim();
