...
export function HackernewsBanner(props: HackernewsBannerProps): JSX.Element {
	...
	return (
		<a
			href="https://echowire.org"
			class="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-4 py-1.5 font-medium text-[#3B82F6] text-sm transition-opacity hover:opacity-90"
		>
