If you believe you have found a security vulnerability in Echowire, please report it responsibly. This policy explains what is in scope, how to submit a report, what we need from you, and what you can expect from us.

## Safe harbor

If you follow this policy, act in good faith, and avoid privacy violations or service disruption, Echowire will not pursue legal action against you for your security research.

## Who should read this

Security researchers, community members, and anyone who discovers a potential security issue in Echowire should read this policy before sending a report. It explains what is in scope, how we triage findings, and how we acknowledge and reward responsible disclosures.

## Scope

### In scope

Echowire websites, applications, and services operated by Proudlock Technology LLC, including the following domains and any subdomain of these domains:

- `echowire.org`

Also in scope:

- Infrastructure, systems, and operational services directly managed by Echowire that impact authentication, authorization, payments, community data, or the processing of security- or privacy-relevant data (including user identifiers, account metadata, logs, analytics, telemetry, and similar signals).
...
- Self-hosted Echowire instances that declare trust in Echowire security guidance, provided:
...
- Social engineering, phishing, bribery, coercion, or attempts to manipulate Echowire staff or users.
...
- General UI bugs, feature requests, or non-security support issues (email support@echowire.org for those).
...
Email your report to security@echowire.org.
...
- A Bug Hunter badge on your Echowire profile.
- Reverb gift codes on echowire.org so you can access premium features.
...
- Please report findings privately to security@echowire.org.
...
Thank you for helping keep Echowire secure.
