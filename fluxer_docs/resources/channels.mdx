...
<a id="channelcreateforumrequest"></a>

## ChannelCreateForumRequest

| Field | Type | Description |
|-------|------|-------------|
| available_tags? | [ForumTagRequest](#forumtagrequest)[] | Tags available in this forum (max 20) |
| bitrate? | ?integer (int32) | Voice channel bitrate in bits per second (8000-320000) |
| name | string | The name of the forum channel |
| nsfw? | boolean | Whether the channel is marked as NSFW |
| parent_id? | ?[SnowflakeType](#snowflaketype) | ID of the parent category for this channel |
| permission_overwrites? | [ChannelOverwriteRequest](#channeloverwriterequest)[] | Permission overwrites for roles and members |
| topic? | ?string | The channel topic (1-1024 characters) |
| type | [ChannelUpdateForumRequestType](#channelupdateforumrequesttype) |  |
| url? | ?string | External URL for link channels |
| user_limit? | ?integer (int32) | Maximum users allowed in voice channel (0-99, 0 means unlimited) |
...
| Field | Type | Description |
|-------|------|-------------|
| applied_tags? | [SnowflakeType](#snowflaketype)[] | Tag IDs applied to a forum thread (max 5) |
| available_tags? | [ForumTagResponse](#forumtagresponse)[] | Available tags for forum channels (max 20) |
...
| message_retention_seconds? | [Int32Type](#int32type) |  |
| name? | string | The name of the channel |
...
| thread_metadata? | [ChannelResponseThreadMetadata](#channelresponsethreadmetadata) | Thread-specific metadata |
...
| message_retention_seconds? | ?integer (int32) | Message retention period in seconds (0-2592000, 0 means forever) |
| name? | ?string | The name of the category |
...
<a id="channelupdateforumrequest"></a>
...
Type: [ChannelUpdateTextRequest](#channelupdatetextrequest) \| [ChannelUpdateVoiceRequest](#channelupdatevoicerequest) \| [ChannelUpdateCategoryRequest](#channelupdatecategoryrequest) \| [ChannelUpdateLinkRequest](#channelupdatelinkrequest) \| [ChannelUpdateGroupDmRequest](#channelupdategroupdmrequest) \| [ChannelUpdateForumRequest](#channelupdateforumrequest)
...
| ping_endpoint | ?string | The URL to ping for latency measurement |
...
<a id="channelupdateforumrequesttype"></a>

## ChannelUpdateForumRequestType

| Value | Description |
|-------|-------------|
| `15` | Channel type (forum channel) |
...
<a id="channelresponsethreadmetadata"></a>

## ChannelResponseThreadMetadata

Thread-specific metadata

| Field | Type | Description |
|-------|------|-------------|
| archive_timestamp | ?string (date-time) | ISO 8601 timestamp when the thread was archived |
| archived | boolean | Whether the thread is archived |
| auto_archive_duration | integer (int32) | Duration in minutes to auto-archive after inactivity |
| invitable? | boolean | Whether non-moderators can add other users to a private thread |
