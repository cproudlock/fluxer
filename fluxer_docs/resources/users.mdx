...
| Field | Type | Description |
|-------|------|-------------|
| fcm_token | string | The FCM registration token to remove |

<a id="fcmtokenregisterrequest"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| device_name? | string | A human-readable device name |
| fcm_token | string | The FCM registration token |
| platform? | string | The device platform (e.g. android, ios) |

<a id="fcmtokenregisterresponse"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| device_id | [SnowflakeType](#snowflaketype) | The unique identifier for the registered device |
