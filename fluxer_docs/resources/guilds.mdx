...
Type: [ChannelCreateTextRequest](#channelcreatetextrequest) \| [ChannelCreateVoiceRequest](#channelcreatevoicerequest) \| [ChannelCreateCategoryRequest](#channelcreatecategoryrequest) \| [ChannelCreateLinkRequest](#channelcreatelinkrequest) \| [ChannelCreateForumRequest](#channelcreateforumrequest)
...
<a id="guildscheduledeventcreaterequest"></a>

## GuildScheduledEventCreateRequest

**Related endpoints**

- [`POST /guilds/{guild_id}/scheduled-events`](/api-reference/guild-scheduled-events/create-a-scheduled-event)

| Field | Type | Description |
|-------|------|-------------|
| channel_id? | ?[SnowflakeType](#snowflaketype) | The voice channel ID (required for voice events) |
| description? | ?string | The description of the event |
| entity_type | enum&lt;`1`, `2`&gt; | The type of event (1 = voice, 2 = external) |
| location? | ?string | The location (required for external events) |
| name | string | The name of the event |
| scheduled_end_time? | ?string | ISO 8601 timestamp for when the event ends |
| scheduled_start_time | string | ISO 8601 timestamp for when the event starts |

<a id="guildscheduledeventlistresponse"></a>

## GuildScheduledEventListResponse

**Related endpoints**

- [`GET /guilds/{guild_id}/scheduled-events`](/api-reference/guild-scheduled-events/list-guild-scheduled-events)

Type: [GuildScheduledEventResponse](#guildscheduledeventresponse)[]

<a id="guildscheduledeventresponse"></a>

## GuildScheduledEventResponse

**Related endpoints**

- [`GET /guilds/{guild_id}/scheduled-events/{event_id}`](/api-reference/guild-scheduled-events/get-a-scheduled-event)
- [`POST /guilds/{guild_id}/scheduled-events`](/api-reference/guild-scheduled-events/create-a-scheduled-event)
- [`PATCH /guilds/{guild_id}/scheduled-events/{event_id}`](/api-reference/guild-scheduled-events/update-a-scheduled-event)

| Field | Type | Description |
|-------|------|-------------|
| channel_id | ?[SnowflakeType](#snowflaketype) | The voice channel ID for voice events |
| cover_image | ?string | The cover image hash |
| created_at | string | ISO 8601 timestamp for when the event was created |
| creator_id | [SnowflakeType](#snowflaketype) | The ID of the user who created the event |
| description | ?string | The description of the event |
| entity_type | number | The type of event (1 = voice, 2 = external) |
| guild_id | [SnowflakeType](#snowflaketype) | The guild this event belongs to |
| id | [SnowflakeType](#snowflaketype) | The unique identifier for this event |
| location | ?string | The location for external events |
| name | string | The name of the event |
| scheduled_end_time | ?string | ISO 8601 timestamp for when the event ends |
| scheduled_start_time | string | ISO 8601 timestamp for when the event starts |
| status | number | The status of the event (1 = scheduled, 2 = active, 3 = completed, 4 = cancelled) |
| user_count | number | The number of users interested in the event |

<a id="guildscheduledeventupdaterequest"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| channel_id? | ?[SnowflakeType](#snowflaketype) | The voice channel ID |
| description? | ?string | The description of the event |
| entity_type? | enum&lt;`1`, `2`&gt; | The type of event |
| location? | ?string | The location |
| name? | string | The name of the event |
| scheduled_end_time? | ?string | ISO 8601 timestamp for when the event ends |
| scheduled_start_time? | string | ISO 8601 timestamp for when the event starts |
| status? | enum&lt;`1`, `2`, `3`, `4`&gt; | The status of the event |

<a id="guildsoundboardplayrequest"></a>

## GuildSoundboardPlayRequest

**Related endpoints**

- [`POST /guilds/{guild_id}/soundboard/play`](/api-reference/guilds/play-a-soundboard-sound-in-a-voice-channel)

| Field | Type | Description |
|-------|------|-------------|
| channel_id | [SnowflakeType](#snowflaketype) | The voice channel to play the sound in |
| sound_id | [SnowflakeType](#snowflaketype) | The ID of the sound to play |

<a id="guildsoundboardsoundlistresponse"></a>

## GuildSoundboardSoundListResponse

**Related endpoints**

- [`GET /guilds/{guild_id}/soundboard`](/api-reference/guilds/list-guild-soundboard-sounds)

Type: [GuildSoundboardSoundResponse](#guildsoundboardsoundresponse)[]

<a id="guildsoundboardsoundresponse"></a>

## GuildSoundboardSoundResponse

**Related endpoints**

- [`GET /guilds/{guild_id}/soundboard/{sound_id}/audio`](/api-reference/guilds/get-soundboard-sound-audio-file)
- [`POST /guilds/{guild_id}/soundboard`](/api-reference/guilds/upload-a-soundboard-sound)
- [`PATCH /guilds/{guild_id}/soundboard/{sound_id}`](/api-reference/guilds/update-a-soundboard-sound)

| Field | Type | Description |
|-------|------|-------------|
| created_at | string | When this sound was created |
| duration_ms | number | The duration of the sound in milliseconds |
| emoji | ?string | The emoji associated with this sound |
| guild_id | [SnowflakeType](#snowflaketype) | The guild this sound belongs to |
| id | [SnowflakeType](#snowflaketype) | The unique identifier for this sound |
| name | string | The name of the sound |
| uploaded_by | [SnowflakeType](#snowflaketype) | The user who uploaded this sound |
| volume | number | The default playback volume (0.0 to 1.0) |

<a id="guildsoundboardupdaterequest"></a>
...
| emoji? | ?string | The emoji associated with this sound |
| name? | string | The name of the sound |
| volume? | number | The default playback volume |
...
- [`GET /admin/guilds/{guild_id}/soundboard`](/api-reference/admin/list-guild-soundboard-sounds)
...
- [`GET /channels/{channel_id}/thread-members`](/api-reference/threads/list-thread-members)
- [`GET /channels/{channel_id}/threads/archived/public`](/api-reference/threads/list-archived-public-threads)
...
- [`GET /guilds/{guild_id}/scheduled-events`](/api-reference/guild-scheduled-events/list-guild-scheduled-events)
- [`GET /guilds/{guild_id}/scheduled-events/{event_id}`](/api-reference/guild-scheduled-events/get-a-scheduled-event)
- [`GET /guilds/{guild_id}/scheduled-events/{event_id}/users`](/api-reference/guild-scheduled-events/list-interested-users)
- [`GET /guilds/{guild_id}/soundboard`](/api-reference/guilds/list-guild-soundboard-sounds)
- [`GET /guilds/{guild_id}/soundboard/{sound_id}/audio`](/api-reference/guilds/get-soundboard-sound-audio-file)
- [`GET /guilds/{guild_id}/stickers`](/api-reference/guilds/list-guild-stickers)
- [`GET /guilds/{guild_id}/threads/active`](/api-reference/threads/list-active-threads)
- [`GET /guilds/{guild_id}/vanity-url`](/api-reference/guilds/get-guild-vanity-url)
...
- [`POST /channels/{channel_id}/threads`](/api-reference/threads/create-a-thread)
...
- [`PUT /channels/{channel_id}/thread-members/{user_id}`](/api-reference/threads/add-a-member-to-a-thread)
- [`PUT /channels/{channel_id}/thread-members/@me`](/api-reference/threads/join-a-thread)
- [`PUT /guilds/{guild_id}/bans/{user_id}`](/api-reference/guilds/ban-guild-member)
- [`PUT /guilds/{guild_id}/members/{user_id}/roles/{role_id}`](/api-reference/guilds/add-role-to-guild-member)
- [`PUT /guilds/{guild_id}/scheduled-events/{event_id}/users/@me`](/api-reference/guild-scheduled-events/mark-interested)
...
- [`PATCH /channels/{channel_id}/thread`](/api-reference/threads/update-a-thread)
- [`PATCH /guilds/{guild_id}`](/api-reference/guilds/update-guild-settings)
- [`PATCH /guilds/{guild_id}/channels`](/api-reference/guilds/update-channel-positions)
- [`PATCH /guilds/{guild_id}/detached-banner`](/api-reference/guilds/toggle-detached-banner)
...
- [`DELETE /admin/guilds/{guild_id}/soundboard/{sound_id}`](/api-reference/admin/delete-a-guild-soundboard-sound)
...
- [`DELETE /channels/{channel_id}/thread`](/api-reference/threads/delete-a-thread)
- [`DELETE /channels/{channel_id}/thread-members/{user_id}`](/api-reference/threads/remove-a-member-from-a-thread)
- [`DELETE /channels/{channel_id}/thread-members/@me`](/api-reference/threads/leave-a-thread)
...
- [`DELETE /guilds/{guild_id}/scheduled-events/{event_id}`](/api-reference/guild-scheduled-events/delete-a-scheduled-event)
- [`DELETE /guilds/{guild_id}/scheduled-events/{event_id}/users/@me`](/api-reference/guild-scheduled-events/remove-interest)
- [`DELETE /guilds/{guild_id}/soundboard/{sound_id}`](/api-reference/guilds/delete-a-soundboard-sound)
